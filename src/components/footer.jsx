    ...
    return (
        <div align="center">
            ...
            <div className="flex flex-col sm:flex-row max-w-8xl justify-between items-center py-8 w-11/12 sm:w-10/12 mx-auto">
                <h1 className="font-sans text-white text-2xl font-semibold flex gap-2 items-end">Blog
                ...
                <h1 className="font-sans text-white text-base flex items-center gap-1">Created with <AiOutlineHeart className="text-rose-600"/> by <span className="text-primary">Barış</span></h1>
            </div>
        </div>
    )
